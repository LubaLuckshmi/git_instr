...
* Для начала работы с удаленным репозиторием нужно __Создать аккаунт на GitHub__
...
В GitHub на вкладке Issures создать New issure и перетащить свое изображение из папки на ПК в описание. Полученную ссылку скопировать и вставить в необходимом месте в редакторе. Сохранить коммит. См. начало страницы